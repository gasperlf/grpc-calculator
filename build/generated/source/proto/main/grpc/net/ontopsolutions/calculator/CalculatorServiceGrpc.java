...
public final class CalculatorServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<net.ontopsolutions.calculator.SumRequest,
      net.ontopsolutions.calculator.SumResponse> getSumMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "sum",
      requestType = net.ontopsolutions.calculator.SumRequest.class,
      responseType = net.ontopsolutions.calculator.SumResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<net.ontopsolutions.calculator.SumRequest,
      net.ontopsolutions.calculator.SumResponse> getSumMethod() {
    io.grpc.MethodDescriptor<net.ontopsolutions.calculator.SumRequest, net.ontopsolutions.calculator.SumResponse> getSumMethod;
    if ((getSumMethod = CalculatorServiceGrpc.getSumMethod) == null) {
      synchronized (CalculatorServiceGrpc.class) {
        if ((getSumMethod = CalculatorServiceGrpc.getSumMethod) == null) {
          CalculatorServiceGrpc.getSumMethod = getSumMethod =
              io.grpc.MethodDescriptor.<net.ontopsolutions.calculator.SumRequest, net.ontopsolutions.calculator.SumResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "sum"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  net.ontopsolutions.calculator.SumRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  net.ontopsolutions.calculator.SumResponse.getDefaultInstance()))
  ...
  public static abstract class CalculatorServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sum(net.ontopsolutions.calculator.SumRequest request,
  ...
  public static final class CalculatorServiceFutureStub extends io.grpc.stub.AbstractFutureStub<CalculatorServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<net.ontopsolutions.calculator.SumResponse> sum(
        net.ontopsolutions.calculator.SumRequest request) {
  ...
  private static abstract class CalculatorServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return net.ontopsolutions.calculator.Calculator.getDescriptor();
    }
